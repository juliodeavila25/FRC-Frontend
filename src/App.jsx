...
import CrearHerramienta from "./pages/recursos_humanos/herramientas/CrearHerramienta";
import { HerramientaProvider } from "./context/herramientaProvider";
import ListarHerramienta from "./pages/recursos_humanos/herramientas/ListarHerramientas";
import EditarHerramienta from "./pages/recursos_humanos/herramientas/EditarHerramienta";

import ListarPreguntas from "./pages/recursos_humanos/preguntas/ListarPreguntas";
import EditarPregunta from "./pages/recursos_humanos/preguntas/EditarPregunta";
import CrearPregunta from "./pages/recursos_humanos/preguntas/CrearPregunta";
                                        ...
                                        <DocumentosRequeridosProvider>
                                          <Routes>
                                            ...
                                            >
                                              <Route
                                                index
                                                path="listar-herramientas"
                                                element={<ListarHerramienta />}
                                              />
                                              <Route
                                                path="crear-herramienta"
                                                element={<CrearHerramienta />}
                                              />

                                              <Route
                                                path="editar-herramienta/:id"
                                            ...
                                            >
                                              <Route
                                                ...
                                                element={<ListarPreguntas />}
                                              />
                                              <Route
                                                path="crear-pregunta"
                                                element={<CrearPregunta />}
                                              />
                                            ...
                                            >
                                              ...
                                              <Route
                                                ...
                                                element={<EditarRequisitosCargos />}
                                              ></Route>
                                            </Route>
