...
const TableHidden = ({ data, columns, href, title, titleButton }) => {
  ...
  const tableInstance = useTable(
    {
      columns,
      data,
      initialState: { hiddenColumns: ["titulo", "output"] }
    },
                  ...
                  {headerGroups.map((headerGroup) => (
                    <tr {...headerGroup.getHeaderGroupProps()}>
                      {headerGroup.headers.map((column, index) => (
                        <th
                          scope="col"
                          className={index !== 3 ? "py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900" : "py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 hidden"}
                    ...
                    return (
                      <tr {...row.getRowProps()}>
                        {row.cells.map((cell, index) => {
                          return (
                            <td
                              className={index !== 3 ? "whitespace-pre-line px-3 py-4 text-sm text-gray-500 truncate" : "whitespace-pre-line px-3 py-4 text-sm text-gray-500 truncate hidden"}
