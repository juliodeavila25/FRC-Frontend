...
import { ConsultarForm } from '../../components/authentication/consultar_admin';
...
export default function Register() {
  ...
  const { obtenerRequestOne, request } = RequestContext;
    ...
    <RootStyle title="Solicitud | Aulas, Salones y Auditorios">
      ...
      <Container>
        <ContentStyle>
          ...
          <ConsultarForm isEdit={isEdit} currentRequest={request}/>
