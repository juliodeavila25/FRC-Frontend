    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'kanban', element: <Kanban /> },
        {
          path: 'espacio',
          children: [
            { element: <Navigate to="/dashboard/espacio/profile" replace /> },
            { path: 'list', element: <EspacioList /> },
            { path: 'new', element: <EspacioCreate /> },
            { path: ':id/edit', element: <EspacioCreate /> }
          ]
        },
        {
          path: 'solicitud',
          children: [
            { element: <Navigate to="/dashboard/espacio/profile" replace /> },
            { path: 'list', element: <SolicitudList /> },
            { path: 'new', element: <SolicitudCreate /> },
            { path: ':id/edit', element: <SolicitudCreate /> }
          ]
        },
        {
          path: 'caracteristica',
          children: [
            { element: <Navigate to="/dashboard/caracteristica/profile" replace /> },
            { path: 'list', element: <CaracteristicaList /> },
            { path: 'new', element: <CaracteristicaCreate /> },
            { path: ':id/edit', element: <CaracteristicaCreate /> }
          ]
        },
        {
          path: 'pregunta',
          children: [
            { element: <Navigate to="/dashboard/pregunta/profile" replace /> },
            { path: 'list', element: <PreguntaList /> },
            { path: 'new', element: <PreguntaCreate /> },
            { path: ':id/edit', element: <PreguntaCreate /> }
          ]
        }
      ]
    },
...
const Consultar = Loadable(lazy(() => import('../pages/authentication/Consultar')));
...
//Planeación
const EspacioList = Loadable(lazy(() => import('../pages/dashboard/EspacioList')));
const EspacioCreate = Loadable(lazy(() => import('../pages/dashboard/EspacioCreate')));
const SolicitudCreate = Loadable(lazy(() => import('../pages/authentication/ConsultarAdmin')));
const SolicitudList = Loadable(lazy(() => import('../pages/dashboard/SolicitudList')));
const CaracteristicaList = Loadable(lazy(() => import('../pages/dashboard/CaracteristicaList')));
const CaracteristicaCreate = Loadable(lazy(() => import('../pages/dashboard/CaracteristicaCreate')));
const PreguntaList = Loadable(lazy(() => import('../pages/dashboard/PreguntaList')));
const PreguntaCreate = Loadable(lazy(() => import('../pages/dashboard/PreguntaCreate')));
// const SolicitudCreate = Loadable(lazy(() => import('../pages/dashboard/UserCreate')));
// Main
